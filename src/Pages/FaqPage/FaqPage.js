...
function Faq() {
  const [faqs, setFaqs] = useState([
    {
      question:
        "Is there a limit to the number of files I can add subtitles to?",
    ...
    },
    {
      ...
      answer:
        "The process is fairly fast but it mostly depends on the length of the file.",
      open: false
    },
    {
      question: "Can I use the app with any kind of audio/video file?",
      answer:
        "The process should work for any kind of audio/video file. If you encounter problems, please let us know and it return, we will let you use the app for free for a total file length of 240 minutes.",
      open: false
    },
    {
      ...
      <div className="content">
        <div className="info-container">
          <h3 className="faq-title">
            In this section we try to answer any questions that you may have
            about our services.
          </h3>
          <div className="faqs">
            {faqs.map((faq, i) => (
